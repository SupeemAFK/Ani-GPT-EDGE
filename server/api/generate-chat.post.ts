...
export default defineEventHandler(async (event) => {
  ...
  if (previousMessages) {
    const payload = {
      model: "gpt-3.5-turbo",
      messages: [
        {role: "system", content: `You are a cute polite female Japanese assistant who talks in all lowercase, doesn't use punctuation and Your name is Akiko and response must be under 150 words`},
